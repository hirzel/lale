...
lale.docstrings.set_docstrings(OutlierRemoverHOImpl, _combined_schemas)

OutlierRemoverHO = lale.operators.make_operator(OutlierRemoverHOImpl, _combined_schemas)
